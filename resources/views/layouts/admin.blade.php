  ...
  <div class="wrapper">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        ...
        <a class="navbar-brand" href="javascript:void(0)">{{ request()->segment(2)}}</a>
          </div>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-navbar">
                  <li class="nav-link">
                    <a href="{{ url('/admin/offers') }}" class="nav-item dropdown-item">Offers</a>
                  </li>
                  <li class="nav-link">
                    <a href="{{ url('/admin/complaints') }}" class="nav-item dropdown-item">Complaints</a>
                  </li>
      ...
      <!-- End Navbar -->
        ...
        @if (session('status') && session('message'))
          <div class="alert alert-{{ session('status') }} alert-home">
              {{ session('message')}}
          </div>
        @endif
      @yield('content')
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright">
            ...
            <a href="javascript:void(0)" target="_blank">QEEK</a>.
          </div>
        </div>
      </footer>
    </div>
